...
public class SortAndMergeIntsFromFiles {
    /**
     * Сортировка целых чисел считанных из файлов, при условии,
     * что каждое число расположено на новой строке.
     * Сортировка слиянием, паттерн "Разделяй и властвуй".
     *
     * @param filePaths принимает varargs путей к файлам в виде строк.
     */
